  ...
  template: `
    <div class="card">
      ...
      <p class="text-lg mb-4">
        Sakai is an application template for Angular and is distributed as a CLI
        project. Current versions is Angular v19 with PrimeNG v19. In case CLI
        is not installed already, use the command below to set it up.
      </p>
      <pre class="app-code">
...
ng serve</code></pre>
      ...
      <p class="text-lg mb-4">
        Templates consists of a couple folders, bases and layout have been
      ...
      <ul class="leading-normal list-disc pl-8 text-lg mb-4">
        ...
        <li>
          <span class="text-primary font-medium">src/app/pages</span>: Base
          content like Dashboard.
        </li>
        <li>
          <span class="text-primary font-medium">src/assets/base</span>: Assets
          used in bases
        </li>
        <li>
      ...
      <p class="text-lg mb-4">
        The base pages are developed with Tailwind CSS however the core
