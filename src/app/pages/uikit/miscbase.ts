      ...
      <div class="md:w-1/2">
        ...
        <div class="card">
          ...
          <p-avatargroup styleClass="mb-4">
            <p-avatar
              image="https://primefaces.org/cdn/primeng/images/base/avatar/amyelsner.png"
              size="large"
              shape="circle"
            ></p-avatar>
            <p-avatar
              image="https://primefaces.org/cdn/primeng/images/base/avatar/asiyajavayant.png"
              size="large"
              shape="circle"
            ></p-avatar>
            <p-avatar
              image="https://primefaces.org/cdn/primeng/images/base/avatar/onyamalimba.png"
              size="large"
              shape="circle"
            ></p-avatar>
            <p-avatar
              image="https://primefaces.org/cdn/primeng/images/base/avatar/ionibowcher.png"
              size="large"
              shape="circle"
            ></p-avatar>
            <p-avatar
              image="https://primefaces.org/cdn/primeng/images/base/avatar/xuxuefeng.png"
              size="large"
              shape="circle"
            ></p-avatar>
            <p-avatar
