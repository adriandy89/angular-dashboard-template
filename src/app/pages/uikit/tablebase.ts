                    ...
                    >
                      <ng-template let-option #item>
                        <div class="flex items-center gap-2 w-44">
                          <img
                            [alt]="option.label"
                            src="https://primefaces.org/cdn/primeng/images/base/avatar/{{
                              option.image
                            }}"
                            width="32"
                          />
          ...
          <tr>
            ...
            <td>
              <div class="flex items-center gap-2">
                <img
                  src="https://primefaces.org/cdn/primeng/images/base/flag/flag_placeholder.png"
...
export class TableBase implements OnInit {
  customers1: Customer[] = [];
