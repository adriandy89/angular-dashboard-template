              ...
              <ng-template #body let-product>
                <tr [pSelectableRow]="product">
                  ...
                  <td>
                    <img
                      [src]="
                        'https://primefaces.org/cdn/primeng/images/base/product/' +
                        product.image
                      "
                      [alt]="product.name"
...
export class OverlayBase implements OnInit {
  images: any[] = [];
  ...
  ngOnInit() {
    ...
    this.images = [];
    this.images.push({
      source: 'assets/base/images/sopranos/sopranos1.jpg',
      thumbnail: 'assets/base/images/sopranos/sopranos1_small.jpg',
      title: 'Sopranos 1',
    });
    this.images.push({
      source: 'assets/base/images/sopranos/sopranos2.jpg',
      thumbnail: 'assets/base/images/sopranos/sopranos2_small.jpg',
      title: 'Sopranos 2',
    });
    this.images.push({
      source: 'assets/base/images/sopranos/sopranos3.jpg',
      thumbnail: 'assets/base/images/sopranos/sopranos3_small.jpg',
      title: 'Sopranos 3',
    });
    this.images.push({
      source: 'assets/base/images/sopranos/sopranos4.jpg',
      thumbnail: 'assets/base/images/sopranos/sopranos4_small.jpg',
      title: 'Sopranos 4',
    });
  }
